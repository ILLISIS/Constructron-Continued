...
script.on_event(ev.on_built_entity, ctron.on_built_entity, {
    ...
    {filter = "force",  force = "player", mode = "and"},
    {filter = "name", name = "constructron-ss-space-spidertron", mode = "or"},
    {filter = "force",  force = "player", mode = "and"},
    {filter = "name", name = "constructron-spidertronmk2", mode = "or"},
    {filter = "force",  force = "player", mode = "and"},
    {filter = "name", name = "constructron-spidertronmk3", mode = "or"},
    {filter = "force",  force = "player", mode = "and"},
